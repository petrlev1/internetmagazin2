...
<form method="post" id="catalogForm" action="/products.php?category=<?php echo $_GET["category"]; ?>&id=<?php echo $_GET["id"]; ?>">
			...
			<div class="inside-padd">
                <div class="title">
                    <span class="f-s_0">
                        ...
                        <span class="d_b">
                            <span class="text-el">Удельный вес</span>
                        </span>
                    </span>
                </div>
                <div class="filters-content">
					...
					$sql_q = "SELECT * FROM intro3 ORDER BY sort ASC";
					$sql_res = $main->q($sql_q);

					while ($rows = mysql_fetch_array($sql_res))
					{
					   if ($main->GetFilterCount("catalog_".$_GET["id"],"cat_reserve",$rows["collname"])>0)
						{
					?>
                                                                                                                                                                         <li>
                                <div class="frame-label" id="brand_289">
                                    <span class="niceCheck b_n">
                                        <input  class="brand289" name="cat_reserve[]" value="'<?php echo $rows["collname"]; ?>'" type="checkbox" />
                                    </span>
                                    <div class="name-count">
                                        <span class="text-el"><?php echo $rows["collname"]; ?></span>
                                        <span class="count">(<?php echo $main->GetFilterCount("catalog_".$_GET["id"],"cat_reserve",$rows["collname"]); ?>)</span>
                                    </div>
                                </div>
                            </li>
                    ...
                    <div class="inside-padd">
                        ...
                        <div class="title">
                            <span class="f-s_0">
                                <span class="icon-arrow"></span>
                                <span class="d_b">
                                    <span class="text-el">Размер</span>
                                </span>
                            </span>
                        </div>
                                                  <div class="filters-content">
					...
					$sql_q2 = "SELECT * FROM intro4 ORDER BY sort ASC";
					$sql_res2 = $main->q($sql_q2);

					while ($rows2 = mysql_fetch_array($sql_res2))
					{
						 if ($main->GetFilterCount("catalog_".$_GET["id"],"cat_number",$rows2["collname"])>0)
						{
					...
					?>
                                ...
                                <div class="frame-label" id="brand_289">
                                    <span class="niceCheck b_n">
                                        <input  class="brand289" name="cat_number[]" value="'<?php echo $rows2["collname"]; ?>'" type="checkbox" />
                                    </span>
                                    <div class="name-count">
                                        <span class="text-el"><?php echo $rows2["collname"]; ?></span>
                                        <span class="count">(<?php echo $main->GetFilterCount("catalog_".$_GET["id"],"cat_number",$rows2["collname"]); ?>)</span>
                                    </div>
                                </div>
                            </li>
					...
					$sql_q2 = "SELECT * FROM intro2 ORDER BY sort ASC";
					$sql_res2 = $main->q($sql_q2);

					while ($rows2 = mysql_fetch_array($sql_res2))
					{
						 if ($main->GetFilterCount("catalog_".$_GET["id"],"cat_sizes",$rows2["collname"])>0)
						{
					...
					?>
                                ...
                                <div class="frame-label" id="brand_289">
                                    <span class="niceCheck b_n">
                                        <input  class="brand289" name="cat_sizes[]" value="'<?php echo $rows2["collname"]; ?>'" type="checkbox" />
                                    </span>
                                    <div class="name-count">
                                        <span class="text-el"><?php echo $rows2["collname"]; ?></span>
                                        <span class="count">(<?php echo $main->GetFilterCount("catalog_".$_GET["id"],"cat_sizes",$rows2["collname"]); ?>)</span>
                                    </div>
                                </div>
                            </li>
					...
					$sql_q3 = "SELECT * FROM intro ORDER BY sort ASC";
					$sql_res3 = $main->q($sql_q3);

					while ($rows3 = mysql_fetch_array($sql_res3))
					{
						 if ($main->GetFilterCount("catalog_".$_GET["id"],"cat_colors",$rows3["collname"])>0)
						{
					...
					?>
                                ...
                                <div class="frame-label" id="brand_289">
                                    <span class="niceCheck b_n">
                                        <input  class="brand289" name="cat_colors[]" value="'<?php echo $rows3["collname"]; ?>'" type="checkbox" />
                                    </span>
                                    <div class="name-count">
                                        <span class="text-el"><?php echo $rows3["collname"]; ?></span>
                                        <span >(<?php echo $main->GetFilterCount("catalog_".$_GET["id"],"cat_colors",$rows3["collname"]); ?>)</span>
                                    </div>
                                </div>
                            </li>
...
<script>
</script>            <div id="popular_products">
