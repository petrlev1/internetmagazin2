...
function RENDER(sPreloadHTML)
	...
	if(this.IsSecurityRestricted)
		...
		sHTML+="<iframe style='width:100%;height:100%; BORDER-RIGHT: #cccccc 1px solid; BORDER-LEFT: #cccccc 1px solid; BORDER-BOTTOM: #cccccc 1px solid; BACKGROUND-COLOR: #f7f7f7' src='"+this.scriptPath+"blank.gif'"+
			" name=idContent"+ this.oName + " id=idContent"+this.oName+
